...
exports.MASTER_ANALYSIS_USER_PROMPT = exports.MASTER_ANALYSIS_SYSTEM_PROMPT = exports.RESUME_MAP_USER_PROMPT = exports.RESUME_MAP_SYSTEM_PROMPT = exports.JD_INTEL_USER_PROMPT = exports.JD_INTEL_SYSTEM_PROMPT = void 0;
exports.JD_INTEL_SYSTEM_PROMPT = `You are a job description analyst. Extract structured intelligence from a job description
...
exports.JD_INTEL_USER_PROMPT = `Analyze this job description and return the following JSON:
...
JOB DESCRIPTION:
{{JD_TEXT}}`;
exports.RESUME_MAP_SYSTEM_PROMPT = `You are a resume parser. Your job is to identify the structural sections of a resume and
...
exports.RESUME_MAP_USER_PROMPT = `Parse this resume and return the following JSON:
...
RESUME TEXT:
{{CLEANED_RESUME_TEXT}}`;
exports.MASTER_ANALYSIS_SYSTEM_PROMPT = `You are an expert resume analyst and career coach with deep knowledge of ATS systems,
...
exports.MASTER_ANALYSIS_USER_PROMPT = `Produce a full resume analysis using the inputs below.
